         ...
         <div class="modal_content" title="클릭하면 창이 닫힙니다.">
            ...
            <form action="diaryinsert.do" method="get">
               ...
               <button class="btn btn-1 hover-filled-slide-down"
                  style="margin: -6px 2px 13px -316px; border-radius: 10px" type="submit" style="border-radius: 10px">
                  <div class="back">
                     <span>저장</span>
                  </div>
               </button>
   ...
   <div id="noticemodal" class="modal1">
      ...
      <!-- <div class="modal_content" title="클릭하면 창이 닫힙니다." style="left: 643px;width: 654px;height: 655px;background: #fff;border-radius: 10px;position: relative;top: 50%;left: 32%;margin-top: -655px;margin-left: -200px;text-align: center;box-sizing: border-box;padding: 74px 0;line-height: 23px;cursor: pointer;"> -->
         ...
         <button id="modalclose" class="btn btn-5 hover-filled-slide-down"
            style="margin: 339px 1px 13px -325px;" style="border-radius: 10px">
            <div class="back">
                     ...
                     <div id="none">
                        <div class="wrap">
                           ...
                           <div class="frame" style="margin-top: 67%">
                              ...
                              <button class="btn btn-1 hover-filled-slide-down"
                                 id="startbtn" style="border-radius: 10px">
                                 <div class="back">
                                    <span>시작하기</span>
                                 </div>
                              </button>
                     ...
                     <div id="none">
                        <div class="wrap">
                           ...
                           <div class="frame" style="margin-top: 67%">
                              ...
                              <button class="btn btn-1 hover-filled-slide-down" id="btn1" style="border-radius: 10px">
                                 <div class="back">
                                    <span>다했어요</span>
                                 </div>
                              </button>
                     ...
                     <div id="none">
                        <div class="wrap">
                           ...
                           <div class="frame" style="margin-top: 67%">
                              ...
                              <button class="btn btn-1 hover-filled-slide-down" id="btn2" style="border-radius: 10px">
                                 <div class="back">
                                    <span>다했어요</span>
                                 </div>
                              </button>
                     ...
                     <div id="none">
                        <div class="wrap">
                           ...
                           <div class="frame" style="margin-top: 67%">
                              ...
                              <button class="btn btn-1 hover-filled-slide-down" id="stopbtn" style="border-radius: 10px">
                                 <div class="back">
                                    <span>다했어요</span>
                                 </div>
                              </button>
